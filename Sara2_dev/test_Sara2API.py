...
def TestSara():
    ...
    sublab_data: saraApi.sublabData = sara2_fuck.ProcessLab(path, roundName, sublab_name)      
    design: saraApi.DesignPerformanceData  = sublab_data.designsList[0]
    test = sublab_data.designsList[0].nupackFoldResults.pairprobsList
    ...
    newSearch: rainbow.GenerateRainbowStructurePlot = rainbow.GenerateRainbowStructurePlot(rainbow.SearchProtocol.FOLDCHANGE, rainbow.NupackFoldDataEnum.PAIRPROBS, sublab_data, 0, 4)
