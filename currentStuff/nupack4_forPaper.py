...
def processPairsPartition(mySequence, primaryCutoff, secondaryCuttoff):
    ...
    for i in range(len(pairsArray)):
        for j in range(len(pairsArray[i])):
            if pairsArray[i][j]>primaryCutoff:
                ...
                primaryPairsList.append(sortmessage)
                print(message)
    print("")
    print("Sorted Primary Pairs")
    primaryPairsList.sort(reverse=True)
    for element in primaryPairsList:
        print(element)
    ...
    for i in range(len(pairsArray)):
        for j in range(len(pairsArray[i])):
            if pairsArray[i][j]<primaryCutoff and pairsArray[i][j]>secondaryCuttoff:
                ...
                secondaryPairsList.append(sortmessage)
                print(message)
    print("")
    print("Sorted Secondary Pairs")
    secondaryPairsList.sort(reverse=True)
    for element in secondaryPairsList:
        print(element)
...
#print pairs
processPairsPartition(sequence, 0.1, .001)
